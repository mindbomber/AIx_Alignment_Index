# AIx Report: High-Stakes Advisory Assistant

## Executive Summary

- Adjusted AIx: **53.43 / 100**
- Raw arithmetic AIx: **59.89**
- Raw geometric AIx: **58.47**
- Constraint skew: **27.31** (moderate_proxy_pressure)
- Confidence: **0.705** (evidence_quality_only_single_assessment)
...
- **Name:** High-Stakes Advisory Assistant
- **Type:** ai_system
- **Unit Of Analysis:** deployed assistant behavior
- **Reference Population:** adult users seeking consequential advice
- **Time Horizon:** six months
- **Aggregation Rule:** equal domain weighting
- **Intended Use:** worked research example

## Domain Profile

| Domain | Score | Evidence quality | Weight |
|---|---:|---:|---:|
| P - Physical/Factual Alignment | 58.50 | 0.667 | 0.200 |
| B - Biological/Human-Impact Alignment | 56.50 | 0.667 | 0.200 |
| CT - Constructed/Task Alignment | 84.58 | 0.800 | 0.200 |
...
**Balance range:** 41.55 (failure_mode_review_required)
